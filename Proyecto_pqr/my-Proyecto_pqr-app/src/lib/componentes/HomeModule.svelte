<script>
  ...
  let stats = { pqrs: 0, usuarios: 0, pendientes: 0 }
  let recentPqrs = []
  let loading = true
...
<div class="home">
  ...
  <div class="section">
    ...
    <div class="actions-grid">
      <button class="action-card" on:click={() => dispatch('navigate', 'pqrs')}>
        <span class="action-icon">＋</span>
        <span class="action-label">Nueva PQR</span>
        <span class="action-desc">Registrar petición, queja o reclamo</span>
      </button>
      <button class="action-card" on:click={() => dispatch('navigate', 'pqrs')}>
        <span class="action-icon">◈</span>
      ...
      {#if isAdmin}
      <button class="action-card" on:click={() => dispatch('navigate', 'usuarios')}>
        <span class="action-icon">◉</span>
